...
<main class="container">
  ...
  <table class="tbl">
    <tr><th>Пользователь</th><th>Курс</th><th>Дата</th><th>Оплата</th><th>Статус</th><th></th></tr>
    <?php foreach ($orders as $order): ?>
      <tr>
        ...
        <td><a href="?delete=<?= (int)$order['id'] ?>" class="del" onclick="return confirm('Удалить заявку?')">✕</a></td>
      </tr>
    <?php endforeach; ?>
  </table>
